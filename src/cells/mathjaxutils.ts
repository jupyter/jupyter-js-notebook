...
import 'mathjax/config/TeX-AMS_HTML-full';
import 'mathjax/jax/output/HTML-CSS/fonts/STIX-Web/fontdata';
import 'mathjax/jax/output/HTML-CSS/fonts/STIX-Web/fontdata-extra';
